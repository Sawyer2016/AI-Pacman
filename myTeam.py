  ...
  """
    ...
    def getFeatures(self, gameState, action):
        ...
        if self.trappedTime > 60:
            ...
            if gameState.getAgentState(self.index).numCarrying>=4:
                ...
                features['DistToNearestGhost']=0
                features['goHome'] = abs(myPos[0] - centerX)

            if distToGhost < 5 and nearestGhost.scaredTimer <2 and not nearestGhost.isPacman:
                features['distanceToFood'] = 0
                features['successorScore'] = -len(powerDots) 
                features['DistToNearestGhost'] = distToGhost               
    ...
    def getWeights(self, gameState, action):
        ...
        return {'successorScore': 1000, 'distanceToFood': -20, 'DistToNearestGhost': 20,
                'goHome': -40, 'attack': 1000,'reverse':-20}
